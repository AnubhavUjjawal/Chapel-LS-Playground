...
export function activate(context: ExtensionContext) {
	...
	client.start();
	// register commands
	commands.registerCommand("extension.sayExtensionEnabled", () => {
		window.showInformationMessage("The Language Support for Chapel has been enabled.");
	})

	commands.executeCommand("extension.sayExtensionEnabled");
}
